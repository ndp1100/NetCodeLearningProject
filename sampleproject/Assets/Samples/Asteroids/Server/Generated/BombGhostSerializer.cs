...
public struct BombGhostSerializer : IGhostSerializer<BombSnapshotData>
{
    // FIXME: These disable safety since all serializers have an instance of the same type - causing aliasing. Should be fixed in a cleaner way
    private ComponentType componentTypeBombTagComponentData;
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<BombSnapshotData>();
    public void BeginSerialize(ComponentSystemBase system)
    {
        componentTypeBombTagComponentData = ComponentType.ReadWrite<BombTagComponentData>();
    ...
    public bool CanSerialize(EntityArchetype arch)
    {
        ...
        {
            if (components[i] == componentTypeBombTagComponentData)
                ++matches;
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref BombSnapshotData snapshot)
    {
        snapshot.tick = tick;
