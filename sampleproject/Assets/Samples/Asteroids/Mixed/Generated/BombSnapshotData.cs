...
public struct BombSnapshotData : ISnapshotData<BombSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref BombSnapshotData baseline1, ref BombSnapshotData baseline2)
    {
    ...
    public void Serialize(ref BombSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref BombSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
    ...
    public void Interpolate(ref BombSnapshotData target, float factor)
    {
